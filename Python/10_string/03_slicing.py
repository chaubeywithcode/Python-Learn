name = "Anurag0123456789"

# print(name[1:3]) # goes from 0 to 2-1 ie 0 to 1

# print(name[2:-1]) # Sam as name[2:4]
...
print(name[1:]) # Replace the first empty number with length # name[1:16]